# 模块 intake 工作明细：项目管理与资料接入

更新时间：2026-04-23

本文档列出模块 intake 负责人的全部开发任务。契约定义见 [contract.md](./contract.md)。

## 1. 概述

模块 intake 是整条管线的起点，负责项目管理、文件上传、Git 仓库接入和补充文本录入。
...
- 不依赖 parsing/agent/workbench/render 任何服务
